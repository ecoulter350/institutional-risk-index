        ...
        <div style={{ padding: '20px 24px', flex: 1 }}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <PanelIndicatorRow
              ...
              threshold={0.509} direction="above"
              ...
              <tbody>
                {paginated.map((inst, i) => (
                  ...
                  >
                    ...
                    <IndicatorDot value={inst.avg_tuition_dep} threshold={0.509} direction="above" label="Tuition dependency" flipTooltip />
                  </tr>
                ))}
              </tbody>
            </table>
