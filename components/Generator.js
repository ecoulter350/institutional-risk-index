...
export default function Generator() {
  ...
  const stressedFlags = selected ? [
    selected.avg_acceptance_rate > 0.733,
    selected.avg_yield_rate < 0.222,
    selected.enrollment_pct_change < -0.118,
    selected.avg_grant_pct > 0.93,
    selected.avg_operating_margin !== null && selected.avg_operating_margin < -0.05,
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ marginBottom: 40, maxWidth: 640 }}>
          ...
          <p style={{
            ...
            Select any of the 1,728 institutions in the dataset. The brief is
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    <span>Models flagging: <strong style={{
                      color: 'var(--text-primary)',
                    }}>{selected.flags_total}/5</strong></span>
                    <span>Stress score: <strong style={{
                      color: 'var(--text-primary)',
                    }}>{selected.stress_score}/7</strong></span>
                  </div>
                </div>
              </div>
            )}
