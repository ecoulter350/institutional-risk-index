      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ marginBottom: 40, maxWidth: 640 }}>
          ...
          <p style={{
            ...
            Select any of the 1,719 institutions in the dataset. The brief is
              ...
              <div style={{
                ...
                <div>
                  <IndicatorRow label="Acceptance rate"
                    ...
                    threshold=">70.1%"
                    stressed={selected.avg_acceptance_rate > 0.701} />
                  ...
                  <IndicatorRow label="Enrollment change"
                    ...
                    threshold="<-16.6%"
                    stressed={selected.enrollment_pct_change < -0.166} />
                  <IndicatorRow label="Grant aid %"
                    value={fmt(selected.avg_grant_pct)}
                    threshold=">97.5%"
                    stressed={selected.avg_grant_pct > 0.975} />
